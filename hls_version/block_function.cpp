...
//     duplicate_stream(input, d_input1, d_input2);
//     // MAIN PATH
//     // Conv 3x3 stride 2
//     conv2D(d_input1, out_3x3_stride2, conv_1_weights_stream, in_h, in_w, in_ch, out_ch, 3, 2, 1);

//     // BN + ReLU
//     batch_norm(out_3x3_stride2, out_3x3_stride2_bn, out_h, out_w, out_ch, block_conv1_bn_mean_stream, block_conv1_bn_deno_stream, block_conv1_bn_gamma_stream, block_conv1_bn_beta_stream);
//     relu(out_3x3_stride2_bn, out_3x3_stride2_relu, OUTPUT_TENSOR_SIZE);
//     // Conv 3x3 stride 1
//     conv2D(out_3x3_stride2_relu, out_3x3_stride1, conv_2_weights_stream, in_h, in_w, in_ch, out_ch, 3, 1, 1);
//     // BN (no ReLU yet)
//     batch_norm(out_3x3_stride1, out_3x3_stride1_bn, out_h, out_w, out_ch, block_conv2_bn_mean_stream, block_conv2_bn_deno_stream, block_conv2_bn_gamma_stream, block_conv2_bn_beta_stream);

//     // SKIP PATH:
//     conv2D(d_input2, skip_out_3x3_stride1, conv_s_weights_stream, in_h, in_w, in_ch, out_ch, 1, 2, 0);
//     batch_norm(skip_out_1x1_stride2, skip_out_1x1_stride2_bn, out_h, out_w, out_ch, skip_bn_mean_stream, skip_bn_deno_stream, skip_bn_gamma_stream, skip_bn_beta_stream);

//     // Add main_path + skip_path
//     skip_add(out_3x3_stride1_bn, skip_out_1x1_stride2_bn, connected_path, OUTPUT_TENSOR_SIZE);

//     // Final ReLU
//     relu(connected_path, out_final, OUTPUT_TENSOR_SIZE);

//     // out2 is the final output
//     for (int i = 0; i < OUTPUT_TENSOR_SIZE; i++) {
//         output.write(out_final.read());
//     }
// }
